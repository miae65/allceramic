...
export function FavoritesEmpty() {
  return (
    <section className="max-w-5xl mx-auto px-6 py-24 flex flex-col items-center text-center">
      ...
      <Link
        href="/"
        className="mt-8 text-xs tracking-[0.2em] uppercase text-stone-900 border-b border-stone-900 pb-0.5 hover:text-stone-500 hover:border-stone-500 transition-colors"
      >
        Explore Works
      </Link>
    </section>
