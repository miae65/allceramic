...
export function MonthlyCollection({ post }: { post: Post }) {
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      <p className="text-xs tracking-widest text-stone-400 uppercase mb-10">이달의 컬렉션</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-10 md:gap-16 items-start">
        ...
        <div className="flex flex-col justify-between h-full md:pt-6">
          <div>
            {/* 월 + 작성자 */}
            <p className="text-xs text-stone-400 tracking-widest uppercase mb-6">{monthLabel}</p>
